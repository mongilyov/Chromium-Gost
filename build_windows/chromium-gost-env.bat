...
echo BORINGSSL_PATH=%BORINGSSL_PATH%
echo CHROMIUM_TAG=%CHROMIUM_TAG%
echo CHROMIUM_FLAGS=%CHROMIUM_FLAGS%
echo DEPOT_TOOLS_PATH=%DEPOT_TOOLS_PATH%
echo CHROMIUM_GOST_REPO=%CHROMIUM_GOST_REPO%
echo CHROMIUM_PRIVATE_ARGS=%CHROMIUM_PRIVATE_ARGS%
echo PATH=%PATH%
